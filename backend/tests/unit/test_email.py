...
from app.modules.auth.service import get_email_config, send_reset_password_email
from app.modules.users.models.user import User


@pytest.fixture
def mock_settings(mocker):
    mock = mocker.patch("app.modules.auth.service.settings")
...
async def test_send_reset_password_email(mock_settings, mock_user, mocker):
    # Mock FastMail
    mock_fastmail = mocker.patch("app.modules.auth.service.FastMail")
