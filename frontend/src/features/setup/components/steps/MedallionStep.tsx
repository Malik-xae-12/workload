...
// MedallionStep
import { CheckCircle2, Loader2, Rocket, ArrowRight, Database } from 'lucide-react';
...
export const MedallionStep = ({ layers, onUpdateLayer, onValidateLayer, onCreateInFabric, loading, error }: MedallionStepProps) => {
            ...
            return (
              <div key={layer.key} className="px-5 py-4">
                ...
                <input
                  ...
                  placeholder={`Enter ${layer.key} layer name (e.g., lh_sales_${layer.key})`}
